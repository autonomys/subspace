...
pub const EXECUTOR_PROTOCOL_NAME: &str = "/subspace/executor/1";
...
pub enum GossipMessage<Block: BlockT> {
	TransactionBundle(Bundle<Block::Extrinsic>),
...
/// An executor for gossip messages.
