...
/// Contains required data for archiver initialization with existing state
#[derive(Debug, Clone)]
pub struct ArchiverInitilizationData<Block> {
    // TODO: convert to separate fields?
    /// Requied fields for archiver initialization: Segment header, SignedBlock and BlockObjectMapping
