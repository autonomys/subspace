...
impl SubspaceCodec {
    ...
    /// should ideally contain at least that many worth of pieces to achieve highest efficiency,
    /// it is recommended that the input is a multiple of that, but, strictly speaking, doesn't
    /// have to be.
    ///
