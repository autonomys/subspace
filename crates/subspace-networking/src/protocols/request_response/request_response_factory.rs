...
/// Event generated by the [`RequestResponseFactory`].
#[derive(Debug)]
pub enum Event {
    ...
    /// A request initiated using [`RequestResponseFactory::send_request`] has succeeded or
    /// failed.
    ///
    /// This event is generated for statistics purposes.
    RequestFinished {
...
pub struct RequestResponseFactory {
...
impl NetworkBehaviour for RequestResponseFactory {
