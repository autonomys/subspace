...
// --heap-pages=4096
// --output=./crates/subspace-runtime/src/weights-tmp/pallet_transporter.rs
...
impl<T: frame_system::Config> pallet_transporter::WeightInfo for WeightInfo<T> {
	...
	fn transfer() -> Weight {
		...
		//  Measured:  `302`
		//  Estimated: `3767`
		// Minimum execution time: 97_778_000 picoseconds.
		Weight::from_parts(98_368_000, 0)
	...
	fn message_response() -> Weight {
		...
		Weight::from_parts(22_139_000, 0)
