...
impl<T: frame_system::Config> pallet_rewards::WeightInfo for WeightInfo<T> {
	...
	fn update_issuance_params(p: u32, v: u32, ) -> Weight {
		...
		Weight::from_parts(3_004_915, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 470
			.saturating_add(Weight::from_parts(10_380, 0).saturating_mul(p.into()))
			// Standard Error: 470
			.saturating_add(Weight::from_parts(3_313, 0).saturating_mul(v.into()))
