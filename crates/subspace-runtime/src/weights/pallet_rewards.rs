...
impl<T: frame_system::Config> pallet_rewards::WeightInfo for WeightInfo<T> {
	...
	fn update_issuance_params(p: u32, v: u32, ) -> Weight {
		...
		Weight::from_parts(4_662_765, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 568
			.saturating_add(Weight::from_parts(9_388, 0).saturating_mul(p.into()))
			// Standard Error: 568
			.saturating_add(Weight::from_parts(667, 0).saturating_mul(v.into()))
