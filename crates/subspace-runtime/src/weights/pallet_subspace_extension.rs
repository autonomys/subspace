...
// --heap-pages=4096
// --output=./crates/subspace-runtime/src/weights-tmp/pallet_subspace_extension.rs
...
impl<T: frame_system::Config> pallet_subspace_extension::WeightInfo for WeightInfo<T> {
	...
	fn vote() -> Weight {
		...
		//  Measured:  `104`
		//  Estimated: `6044`
		// Minimum execution time: 2_199_383_000 picoseconds.
		Weight::from_parts(2_203_553_000, 0)
	...
	fn vote_with_equivocation() -> Weight {
		...
		//  Measured:  `203`
		//  Estimated: `6143`
		// Minimum execution time: 2_204_713_000 picoseconds.
		Weight::from_parts(2_210_913_000, 0)
