    ...
    TransactionPool: sc_transaction_pool_api::TransactionPool<Block = Block>,
{
        ...
        R: ReceiptInterface<SBlock::Hash>,
    {
        ...
        let receipts = if primary_number.is_zero() {
            ...
            self.collect_core_bundle_receipts(best_system_hash, parent_number, receipt_interface)?
        };
    ...
    fn collect_core_bundle_receipts<R>(
        &self,
        ...
        R: ReceiptInterface<SBlock::Hash>,
    {
        let best_execution_chain_number =
            receipt_interface.best_execution_chain_number(system_block_hash)?;
        let max_drift = receipt_interface.maximum_receipt_drift(system_block_hash)?;
