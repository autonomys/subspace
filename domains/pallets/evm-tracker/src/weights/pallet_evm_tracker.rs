...
impl<T: frame_system::Config> crate::WeightInfo for WeightInfo<T> {
	...
	fn evm_contract_check_multiple(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_663_159, 0)
			.saturating_add(Weight::from_parts(0, 1694))
			// Standard Error: 21
			.saturating_add(Weight::from_parts(10_018, 0).saturating_mul(c.into()))
	...
	fn evm_contract_check_nested(c: u32, ) -> Weight {
		...
		Weight::from_parts(3_881_048, 0)
			.saturating_add(Weight::from_parts(0, 1694))
			// Standard Error: 144
			.saturating_add(Weight::from_parts(90_308, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	}
}
