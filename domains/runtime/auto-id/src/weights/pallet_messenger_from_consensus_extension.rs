...
// --heap-pages=4096
// --output=./domains/runtime/auto-id/src/weights-tmp/pallet_messenger_from_consensus_extension.rs
...
impl<T: frame_system::Config> pallet_messenger_from_consensus_extension::WeightInfo for WeightInfo<T> {
	...
	fn from_consensus_relay_message_channel_open() -> Weight {
		...
		Weight::from_parts(36_959_000, 0)
