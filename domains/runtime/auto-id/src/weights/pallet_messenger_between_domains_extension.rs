...
// --heap-pages=4096
// --output=./domains/runtime/auto-id/src/weights-tmp/pallet_messenger_between_domains_extension.rs
...
impl<T: frame_system::Config> pallet_messenger_between_domains_extension::WeightInfo for WeightInfo<T> {
	...
	fn from_domains_relay_message_channel_open() -> Weight {
		...
		Weight::from_parts(38_239_000, 0)
