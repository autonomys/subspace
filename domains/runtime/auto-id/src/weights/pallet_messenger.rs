...
// --output=./domains/runtime/auto-id/src/weights/pallet_messenger.rs
...
impl<T: frame_system::Config> pallet_messenger::WeightInfo for WeightInfo<T> {
	...
	fn initiate_channel() -> Weight {
		...
		//  Measured:  `62`
		//  Estimated: `3599`
		// Minimum execution time: 60_399_000 picoseconds.
		Weight::from_parts(61_949_000, 0)
	...
	fn relay_message_response() -> Weight {
		...
		Weight::from_parts(27_049_000, 0)
