...
// --heap-pages=4096
// --output=./domains/runtime/evm/src/weights-tmp/domain_pallet_executive.rs
...
impl<T: frame_system::Config> domain_pallet_executive::WeightInfo for WeightInfo<T> {
	...
	fn set_code() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 20_711_348_000 picoseconds.
		Weight::from_parts(20_790_097_000, 0)
