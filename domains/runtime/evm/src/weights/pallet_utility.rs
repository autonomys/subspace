...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_550_000, 0)
			...
			.saturating_add(Weight::from_parts(3_336_180, 0).saturating_mul(c.into()))
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_589_000, 0)
			...
			.saturating_add(Weight::from_parts(3_529_855, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_610_000, 0)
			...
			.saturating_add(Weight::from_parts(3_289_506, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
